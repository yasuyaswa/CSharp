...
namespace CsharpPractice
{
    class Program
    {
        public static void Main()
        {
            ...
            //tables.table(n);
            //PrimeNumberCheck.PrimeCheck(n);
            // PatternPyramidWithNumbersRightAngle.PatternNumber(n);
            // PatternPyramidEquilateral.PatternEquilateral(n);
            //int num = Convert.ToInt32(Console.ReadLine());
            //months.MonthName(n);
            //Console.WriteLine(Palindrome.pal(n));
            //Console.WriteLine(SumOfDigits.SOD(n));
            //SwapNumber.swap();
            //NumberInCharacters.nic();
            ...
            //ChangingLowerToUpperCaseViceVersa.ChangingToLowerCase(input);
            //LoginCheck.Login();
            //SearchThePositionOfSubString.SearchPositionSubString();
            //AlphabetPositionInString.AlphabetPosition();
            //RegularExpressionForEmail.RegularExpression(input);
            // RegularExpressionForPassword.RegularExpression(input);
            //MinMax.MinMaxi();
            //FirstAndLastCharChange.FirstLastCharChange(input);
            //FileHandling.FileHandlings();
            // CurrentDateTime.CurrentDT();
            // AbbreviationOfText.Abbreviation(input);
            // PaddingString.Padding(input);
            // RandomString.RandomStr();
            //MagicNumber.Magic(n);
            //Anagram.Anagrams();
            //Panagram.Panagrams(input);
            //Heterogram.Heterograms(input);
            // PatternFullPyramid.PatternFull(n);
            // TableSingle.SingleTable(n);
            // DateOnly BirthDate= DateOnly.Parse("1999-10-14");
            // AgeCal.Age(BirthDate);
            // NegToPos.NegToPositive(n);
            // RockPaperScissors.RockPaperScissor("scissors", "paper");
            //YearToCentury.YearCentury(n);
            // Waste.Was(input);
